...
##    if f5==2:
##        var=None
##        a = Radiobutton(easy_frame,text=easyQ[x][2],font="verdana 12",value=easyQ[x][2],variable = var,bg="yellow")
##        a.place(relx=0.5,rely=0.42,anchor=CENTER)
##
##        b = Radiobutton(easy_frame,text=easyQ[x][3],font="verdana 12",value=easyQ[x][3],variable = var,bg="yellow")
##        b.place(relx=0.5,rely=0.52,anchor=CENTER)
##
##        c = Radiobutton(easy_frame,text=easyQ[x][4],font="verdana 12",value=easyQ[x][4],variable = var,bg="yellow")
##        c.place(relx=0.5,rely=0.62,anchor=CENTER) 
##
##        d = Radiobutton(easy_frame,text=easyQ[x][1],font="verdana 12",value=easyQ[x][1],variable = var,bg="yellow")
##        d.place(relx=0.5,rely=0.72,anchor=CENTER)
##        answer = [
##            d8,
##            c10,
...
##    elif f5==3:
##        var=None
##        a = Radiobutton(easy_frame,text=easyQ[x][3],font="verdana 12",value=easyQ[x][3],variable = var,bg="yellow")
##        a.place(relx=0.5,rely=0.42,anchor=CENTER)
##        var=None
##
##        b = Radiobutton(easy_frame,text=easyQ[x][4],font="verdana 12",value=easyQ[x][4],variable = var,bg="yellow")
##        b.place(relx=0.5,rely=0.52,anchor=CENTER)
##        var=None
##
##        c = Radiobutton(easy_frame,text=easyQ[x][1],font="verdana 12",value=easyQ[x][1],variable = var,bg="yellow")
##        c.place(relx=0.5,rely=0.62,anchor=CENTER)
##        var=None
##
##        d = Radiobutton(easy_frame,text=easyQ[x][2],font="verdana 12",value=easyQ[x][2],variable = var,bg="yellow")
##        d.place(relx=0.5,rely=0.72,anchor=CENTER)
##
##
##        answer = [
...
##    elif f5==4:
##        var=None
##        a = Radiobutton(easy_frame,text=easyQ[x][4],font="verdana 12",value=easyQ[x][4],variable = var,bg="yellow")
##        a.place(relx=0.5,rely=0.42,anchor=CENTER)
##        var=None
##
##        b = Radiobutton(easy_frame,text=easyQ[x][3],font="verdana 12",value=easyQ[x][3],variable = var,bg="yellow")
...
##        var=None
##
##        c = Radiobutton(easy_frame,text=easyQ[x][2],font="verdana 12",value=easyQ[x][2],variable = var,bg="yellow")
##        c.place(relx=0.5,rely=0.62,anchor=CENTER)
##        var=None
##
##        d = Radiobutton(easy_frame,text=easyQ[x][1],font="verdana 12",value=easyQ[x][1],variable = var,bg="yellow")
