...
##        display()
    ...
    khalisir=Tk()
    label1=Label(khalisir,text="Halo dost ;)")
    label1.pack()
...
def menu():
    ...
    var = IntVar()
    easyR = Radiobutton(menu_frame,text='1 player(against computer)',bg="white",font="calibri 16",value=1,variable = var)
    easyR.place(relx=0.25,rely=0.4)
    
    mediumR = Radiobutton(menu_frame,text='2 players',bg="white",font="calibri 16",value=2,variable = var)
...
def easy():
    ...
    wel = Label(menu1_canvas,text=' W E L C O M E  T O  Q U I Z  S T A T I O N ',fg="white",bg="#101357") 
    wel.config(font=('Broadway 22'))
    wel.place(relx=0.1,rely=0.02)
    
    
    level = Label(menu1_frame,text='Select the number of overs !!',bg="white",font="calibri 18")
    level.place(relx=0.25,rely=0.3)
    
    
    var = IntVar()
    easyR1 = Radiobutton(menu1_frame,text='1 over',bg="white",font="calibri 16",value=1,variable = var)
    easyR1.place(relx=0.25,rely=0.4)
    
    mediumR1 = Radiobutton(menu1_frame,text='2 overs',bg="white",font="calibri 16",value=2,variable = var)
    mediumR1.place(relx=0.25,rely=0.5)
    
    hardR1 = Radiobutton(menu1_frame,text='3 overs',bg="white",font="calibri 16",value=3,variable = var)
    hardR1.place(relx=0.25,rely=0.6)

    letsgo1 = Button(menu1_frame,text="Let's Go",bg="white",font="calibri 12",command=easyques)
...
##L3=Label(root,text='Which tree did he see least:',fg='green',font='lucida 10 bold').grid(row=3,column=0)
...
##             ]
   ...
   # x = random.choice(li[1:])
    ...
    ques = Label(easy_frame,text =elements[options],font="calibri 24",bg="white")
    ques.place(relx=0.5,rely=0.2,anchor=CENTER)

    var = StringVar()

  #  a =Entry(easy_frame,textvariable=var)
  #  a.place(relx=0.5,rely=0.42,anchor=CENTER)
