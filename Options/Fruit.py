...
FRUITS_ANSWER = ['lithium','beryllium','sodium','magnesium','aluminium','potassium','calcium','scandium','titanium',
                 'vanadium','chromium','manganese','iron','cobalt','nickel','copper','zinc','gallium','rubidium']
...
for i in range(len(FRUITS_ANSWER)):
    word=FRUITS_ANSWER[i]
    word0=''
    i=0
    l=list(word)
    random.shuffle(l)
    #print(listtostring(l))
    FRUITS_WORD.append(listtostring(l))
